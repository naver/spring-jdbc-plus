...
class IterableExpandPaddingTest {
	...
	void arrayConverter() {
		IterableExpandPadding.ArrayExpandPadding sut = IterableExpandPadding.ArrayExpandPadding.INSTANCE;
	...
	void collectionConverter() {
		IterableExpandPadding.CollectionExpandPadding sut = IterableExpandPadding.CollectionExpandPadding.INSTANCE;
